...
public class AcideReplaceWindow extends JFrame {
	...
	private void setListeners() {
		...
		_searchButton.addKeyListener(new AcideSearchAndReplaceWindowKeyboardListener());

		// REPLACE BUTTON
		_replaceButton.addActionListener(new ReplaceButtonListener());
		_replaceButton.addKeyListener(new AcideSearchAndReplaceWindowKeyboardListener());

		// REPLACE ALL BUTTON
		_replaceAllButton.addActionListener(new ReplaceAllButtonListener());
		_replaceAllButton.addKeyListener(new AcideSearchAndReplaceWindowKeyboardListener());
		...
		_replaceTextField.addKeyListener(new AcideSearchAndReplaceWindowKeyboardListener());
		_replacedTextField.addKeyListener(new AcideSearchAndReplaceWindowKeyboardListener());
	...
	class SearchButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (_replaceTextField.getText().equals("")) {
				...
				// Error message
				AcideReplaceWindow.getInstance().setTop(false);
				JOptionPane.showMessageDialog(null, AcideLanguageManager
						.getInstance().getLabels().getString("s585"), "Error",
						JOptionPane.ERROR_MESSAGE);
				AcideReplaceWindow.getInstance().setTop(true);
				...
				if (_currentDocumentRadioButton.isSelected()) {
					...
					_result = AcideMainWindow.getInstance().getFileEditorManager()
					...
					if (direccion == AcideSearchDirection.BACKWARD)
						_result = AcideMainWindow.getInstance()
								.getFileEditorManager()
