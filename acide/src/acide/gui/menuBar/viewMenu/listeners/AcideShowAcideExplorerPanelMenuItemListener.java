 ...
 * @see ActionListener																													
 */
public class AcideShowAcideExplorerPanelMenuItemListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (AcideMainWindow.getInstance().getMenu().getViewMenu().getShowExplorerPanelCheckBoxMenuItem().isSelected())
