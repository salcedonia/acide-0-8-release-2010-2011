		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			try {
				...
				if (AcideMainWindow.getInstance().getFileEditorManager()
					...
					execution = execution.replace("$activeFile$", AcideMainWindow
					...
					execution = execution.replace("$activeFileExt$", AcideMainWindow
							.getInstance().getFileEditorManager()
					...
					arguments = arguments
							.replace("$activeFilePath$", AcideMainWindow
									.getInstance().getFileEditorManager()
									.getSelectedFileEditorPanel().getFilePath());
					arguments = arguments.replace("$activeFileExt$", AcideMainWindow
							.getInstance().getFileEditorManager()
							.getSelectedFileEditorPanel().getFileExtension());
					arguments = arguments
							.replace("$activeFileName$", AcideMainWindow
				...
				if (AcideProjectConfiguration.getInstance().isDefaultProject()) {
					...
					if (AcideMainWindow.getInstance().getFileEditorManager()
						...
						execution = execution.replace("$mainFile$", AcideMainWindow
								.getInstance().getFileEditorManager()
								.getMainFileEditorPanel().getAbsolutePath());
