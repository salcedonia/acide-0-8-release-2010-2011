package gui.editor.editorPanel.popup;
...
public class EditorPopupMenu extends JPopupMenu {
	...
	public EditorPopupMenu() {
					...
					if (currentSelection != null) {
						...
						if (!p.isDirectory()) {
							...
							if (parent != null) {
								...
								// Closes the tab
								MainWindow.getInstance().getEditorManager()
										.getPane().remove(selectedEditorIndex);
								
								// No more tabs
								if (MainWindow.getInstance().getEditorManager()
										.getPane().getTabCount() == 0) {
		...
		_setCompilable.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent actionEvent) {
				MainWindow.getInstance().getEditorManager().setCompilableFile();
			}
		});
		add(_setCompilable);
		...
		_setMain.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent actionEvent) {
				MainWindow.getInstance().getEditorManager().setMainFile();
			}
		});
		add(_setMain);
		...
		_unsetMain.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent actionEvent) {
				MainWindow.getInstance().getEditorManager().unsetMainFile();
			}
		});
		add(_unsetMain);
		addSeparator();
