package gui.editor.editorManager.utils.gui;
	...
	class CDropTargetListener implements DropTargetListener {
		...
		public void dragOver(final DropTargetDragEvent dropTargetEvent) {
			...
			if (getTabPlacement() == JTabbedPane.TOP
				...
				initTargetLeftRightLine(getTargetTabIndex(dropTargetEvent.getLocation()));
			} else {
				initTargetTopBottomLine(getTargetTabIndex(dropTargetEvent.getLocation()));
			}
			repaint();
			if (hasGhost()) {
		...
		public void drop(DropTargetDropEvent dropTargetEvent) {
			...
			if (isDropAcceptable(dropTargetEvent)) {
				convertTab(_dragTabIndex, getTargetTabIndex(dropTargetEvent.getLocation()));
