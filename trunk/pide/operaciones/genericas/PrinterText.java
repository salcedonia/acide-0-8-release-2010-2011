...
public class PrinterText implements Printable {
	...
	static final Font headerFont = new Font("Arial", Font.BOLD, 12);
	...
	public int print(Graphics g, PageFormat format, int pageIndex) {
		...
		headerFont.getStringBounds(res, g2.getFontRenderContext());
		LineMetrics metrics = // Get the ascent and descent of the font
		headerFont.getLineMetrics(res, g2.getFontRenderContext());
