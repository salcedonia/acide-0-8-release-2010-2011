...
public class AcideLanguage {
	...
	/**
	 * Language unique class instance
	 */
	private static AcideLanguage _instance;
	 ...
	 */
	public static AcideLanguage getInstance() {
		if (_instance == null)
			_instance = new AcideLanguage();
		return _instance;
	}
