...
public class LexiconConfiguration {
	...
	public void newLexical(String path) {
		...
		// Resets the lexical configuration parameters
		...
		ResourceManager.getInstance().setProperty("languagePath", path);
	...
	public boolean save(String name, boolean isCompiledOrInterpreted) {
		...
		if ((_languageName != null)
			...
			// Updates the RESOURCE MANAGER
			ResourceManager.getInstance().setProperty("languagePath", _languagePath);
		}
		return true;
	}
