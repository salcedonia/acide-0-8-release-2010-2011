...
public class AcideCloseProjecMenuItemtListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (!isCancelOptionSelected) {
			...
			AcideMainWindow.getInstance().getMenu().getFileMenu().getCloseAllFilesMenuItem()
					.setEnabled(true);
			...
			AcideMainWindow.getInstance().getMenu().getFileMenu().getOpenAllFilesMenuItem().setEnabled(false);
