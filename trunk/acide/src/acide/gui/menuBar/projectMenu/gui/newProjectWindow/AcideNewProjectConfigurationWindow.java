...
public class AcideNewProjectConfigurationWindow extends JFrame {
	...
	/**
	 * ACIDE - A Configurable IDE new project configuration window previous
	 * project name.
	 */
	...
	public void updateExplorerPanel() {
		...
		for (int index = 0; index < AcideMainWindow.getInstance()
			...
			if (!AcideMainWindow.getInstance().getFileEditorManager()
				...
				// It is opened
				newProjectFile.setIsOpened(true);
	...
	public void updateProjectConfiguration() {
		...
		try {
			...
			_previousProjectName = AcideProjectConfiguration
					.getInstance().getName();
	...
	public void updateConsolePanel() {
		...
		AcideResourceManager.getInstance().setProperty(
				...
				AcideProjectConfiguration.getInstance().getForegroundColor()
						.toString());
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (!_nameTextField.getText().equals("")) {
				...
				if (fileProject.exists()) {
					...
					AcideProjectConfiguration.getInstance()
							.updateFileListProjectConfiguration(
									_previousProjectName,
									_nameTextField.getText());
