...
public class AcideReplaceWindow extends JFrame {
	...
	private void setListeners() {
		...
		// Adds the search replace key listener to all the window components
		AcideSearchReplaceWindowKeyboardListener searchReplaceKeyListener = new AcideSearchReplaceWindowKeyboardListener();

		// Adds the status bar keyboards listener to all the window components
		// components
		...
		for (Component component : components) {
			...
			component.addKeyListener(searchReplaceKeyListener);
		}
	}
