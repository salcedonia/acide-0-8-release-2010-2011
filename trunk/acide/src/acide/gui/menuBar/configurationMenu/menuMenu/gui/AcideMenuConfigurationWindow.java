...
//		for (int index1 = 0; index1 < AcideMainWindow.getInstance().getMenu()
//				.getMenuCount(); index1++) {
//
//			// Gets the current menu
//			JMenu menu = AcideMainWindow.getInstance().getMenu().getMenu(index1);
//
//			// If it is the configuration menu
//			if (menu.getText().matches(
//					AcideLanguageManager.getInstance().getLabels()
//							.getString("s5"))) {
//
//				// Creates the internal panel that contains the configuration
//				// panel and the tabbed panel
//				JPanel internalPanel = new JPanel(new BorderLayout());
//
//				// Adds the configuration panel
//				internalPanel.add(new AcideMenuConfigurationPanel(menu),
//						BorderLayout.NORTH);
//
//				// Creates the internal tabbed pane
//				JTabbedPane tabbedPane = new JTabbedPane();
//
//				for (int index2 = 0; index2 < menu.getItemCount(); index2++) {
//
//					// If it is not a separator
//					if (menu.getItem(index2) != null) {
//
//						// If it is not the compiler menu item
//						if (!menu
//								.getItem(index2)
//								.getText()
//								.matches(
...
//
//							// Creates the panel
//							AcideMenuConfigurationPanel panel = new AcideMenuConfigurationPanel(
//									(JMenu) menu.getMenuComponent((index2)));
//
//							if (_forModifying)
//
//								// Sets the check boxes from the menu item list
//								panel.setCheckBoxesFromMenuItemList();
//
//							// Adds the tab
//							tabbedPane.addTab(menu.getItem(index2).getText(),
//									panel);
//						}
//					}
//				}
//				
//				// Adds the tabbed pane to the internal panel
//				internalPanel.add(tabbedPane, BorderLayout.CENTER);
//
//				// Adds the tab
//				_tabbedPane.addTab(menu.getText(), internalPanel);
//			} else {
//
//				// Creates the panel
//				AcideMenuConfigurationPanel panel = new AcideMenuConfigurationPanel(
...
//
//				// Adds the tab
//				_tabbedPane.addTab(menu.getText(), panel);
//			}
//		}
