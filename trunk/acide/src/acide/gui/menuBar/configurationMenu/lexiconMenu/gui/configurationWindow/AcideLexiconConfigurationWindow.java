...
public class AcideLexiconConfigurationWindow extends JFrame {
	...
	private void setListeners() {
		...
		_saveAsButton
				.addActionListener(new SaveLexiconAsButtonAction());
	...
	class SaveLexiconAsButtonAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			try {
				...
				int returnValueSaveFile = _fileChooser.showSaveDialog(null);
				...
				if (returnValueSaveFile == JFileChooser.APPROVE_OPTION) {
					...
					if (absoluteFilePath != null) {
						...
						if (!absoluteFilePath.contains(".xml"))

							// Adds it to the name
							absoluteFilePath = absoluteFilePath + ".xml";
						...
						boolean isSaved = AcideMainWindow.getInstance()
								...
								.getSelectedFileEditorPanel()
								.getLexiconConfiguration()
								.saveAs(fileName, false, absoluteFilePath);
						...
						if (isSaved) {
							...
							JOptionPane.showMessageDialog(null,
									AcideLanguageManager.getInstance()
											.getLabels().getString("s451"),
									AcideLanguageManager.getInstance()
											.getLabels().getString("s450"),
						...
						AcideResourceManager.getInstance().setProperty(
								"lastOpenedFileDirectory", absoluteFilePath);
					} else
