 ...
 * @see JFrame
 */
public class AcidePredetermineLexiconWindow extends JFrame {

	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window serial version
	 * UID.
	 */
	private static final long serialVersionUID = 1L;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window image icon.
	 */
	private static final ImageIcon ICON = new ImageIcon(
			"./resources/images/icon.png");
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window main panel.
	 */
	private JPanel _mainPanel;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window table.
	 */
	private JTable _table;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window table scroll pane.
	 */
	private JScrollPane _tableScrollPane;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window table button
	 * panel.
	 */
	private JPanel _tableButtonPanel;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window add lexicon
	 * assigner button.
	 */
	private JButton _addLexiconAssignerButton;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window remove lexicon
	 * assigner button.
	 */
	private JButton _removeLexiconAssignerButton;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window button panel.
	 */
	private JPanel _buttonPanel;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window accept button.
	 */
	private JButton _acceptButton;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window cancel button.
	 */
	private JButton _cancelButton;
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window are there changes
	 * flag.
	 */
	private boolean _areThereChanges;

	/**
	 * Creates a new ACIDE - A Configurable IDE predetermine lexicon window.
	 */
	public AcidePredetermineLexiconWindow() {
	...
	/**
	 * Builds the ACIDE - A Configurable IDE predetermine lexicon window table.
	 */
	private void buildTable() {
		...
		((AcidePredetermineLexiconWindowTableModel) _table.getModel())
				.setItems(AcideLexiconAssignerConfiguration.getInstance()
						.getList());
	...
	/**
	 * Adds the components to the ACIDE - A Configurable IDE predetermine
	 * lexicon window.
	 */
	...
	/**
	 * Builds the ACIDE - A Configurable IDE predetermine lexicon window button
	 * panel.
	 */
	...
	/**
	 * Builds the ACIDE - A Configurable IDE predetermine lexicon window main
	 * panel.
	 */
	...
	/**
	 * Builds the ACIDE - A Configurable IDE predetermine lexicon window file
	 * type list button panel.
	 */
	...
	/**
	 * Sets the listeners for the ACIDE - A Configurable IDE predetermine
	 * lexicon window components.
	 */
	...
	/**
	 * Sets the ACIDE - A Configurable IDE predetermine lexicon window
	 * configuration.
	 */
	...
	private void applyChanges() {
		...
		AcideLexiconAssignerConfiguration.getInstance().setList(
				((AcidePredetermineLexiconWindowTableModel) _table.getModel())
						.getItems());
	...
	/**
	 * Closes the ACIDE - A Configurable IDE predetermine lexicon window.
	 */
	...
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window window listener.
	 * 
	 * @version 0.8
	 * @see WindowAdapter
	 */
	...
	/**
	 * ACIDE - A Configurable IDE predetermine lexicon window table mouse
	 * listener.
	 * 
	 * @version 0.8
	 * @see MouseAdapter
