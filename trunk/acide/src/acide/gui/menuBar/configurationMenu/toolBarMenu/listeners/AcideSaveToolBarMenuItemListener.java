...
public class AcideSaveToolBarMenuItemListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		try {
			...
			// Gets the ACIDE - A Configurable IDE previous tool bar configuration
			String previousToolBarConfiguration = AcideResourceManager.getInstance().getProperty(
					"previousToolBarConfiguration");
			
			// Gets the ACIDE - A Configurable IDE previous tool bar configuration
			String currentToolBarConfiguration = AcideResourceManager.getInstance().getProperty(
					"currentToolBarConfiguration");
			
			// Copies the files
			AcideByteFile.copy(currentToolBarConfiguration, previousToolBarConfiguration);
