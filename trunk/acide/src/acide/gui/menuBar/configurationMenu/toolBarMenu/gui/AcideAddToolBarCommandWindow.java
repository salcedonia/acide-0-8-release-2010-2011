...
public class AcideAddToolBarCommandWindow extends JFrame {
	...
	/**
	 * Builds the ACIDE - A Configurable IDE add tool bar command window
	 * components.
	 */
	...
	/**
	 * Sets the ACIDE - A Configurable IDE add tool bar command window
	 * configuration.
	 */
	...
	/**
	 * Adds the components to the ACIDE - A Configurable IDE add tool bar
	 * command window with the layout.
	 */
	...
	/**
	 * Sets the listeners to the ACIDE - A Configurable IDE add tool bar command
	 * window components.
	 */
