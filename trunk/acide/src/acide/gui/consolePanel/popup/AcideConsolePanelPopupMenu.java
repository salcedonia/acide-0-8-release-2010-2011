...
import acide.gui.consolePanel.popup.listeners.AcideSaveConsoleContentIntoFileMenuItemAction;
import acide.gui.consolePanel.popup.listeners.AcideSearchConsoleMenuItemAction;
...
public class AcideConsolePanelPopupMenu extends JPopupMenu {
	...
	private void addComponents() {
		...
		// Adds the save console content into file menu item to the popup menu
	...
	public void setListeners() {
		...
		_saveConsoleContentIntoFile
				.addActionListener(new AcideSaveConsoleContentIntoFileMenuItemAction());
		...
		_searchMenuItem
				.addActionListener(new AcideSearchConsoleMenuItemAction());
