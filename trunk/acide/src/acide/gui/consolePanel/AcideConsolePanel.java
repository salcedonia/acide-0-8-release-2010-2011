...
public class AcideConsolePanel extends JPanel {
	...
	public void setLookAndFeel() {
		...
		try {
			...
			setForegroundColor(AcideUtilities.getInstance().parseStringToColor(
					AcideResourceManager.getInstance().getProperty(
							"consolePanel.foregroundColor")));

			// Sets the background color
			setBackgroundColor(AcideUtilities.getInstance().parseStringToColor(
					AcideResourceManager.getInstance().getProperty(
							"consolePanel.backgroundColor")));

			// Sets the caret color
			_textPane.setCaretColor(AcideUtilities.getInstance()
					.parseStringToColor(
							AcideResourceManager.getInstance().getProperty(
									"consolePanel.foregroundColor")));
