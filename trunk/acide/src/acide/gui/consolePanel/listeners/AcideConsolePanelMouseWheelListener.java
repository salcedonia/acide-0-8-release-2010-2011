...
/**
 * <p>
 * ACIDE - A Configurable IDE console panel mouse wheel listener.
 * </p>
 * <p>
 * When the user uses the combination control key + mouse wheel in a console
 * panel text edition area the font size of all the opened console panels
 * changes.
 * </p>
 * 
 * @version 0.8
 * @see JPanel
 */
public class AcideConsolePanelMouseWheelListener implements MouseWheelListener {
