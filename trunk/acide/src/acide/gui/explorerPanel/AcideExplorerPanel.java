...
import acide.files.AcideValidExtensionsManager;
...
public class AcideExplorerPanel extends JPanel {
	...
	public void buildTree(DefaultMutableTreeNode node, File file) {
		...
		AcideValidExtensionsManager validExtensions = AcideValidExtensionsManager.getInstance();
	...
	public void disposeExplorerPanel() {
		...
		_explorerSize = AcideMainWindow.getInstance().getVerticalSplitPane()
				.getDividerLocation();
		AcideMainWindow.getInstance().getVerticalSplitPane().setDividerLocation(0);
