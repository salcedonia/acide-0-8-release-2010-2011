...
public class AcideExplorerPanelPopupMenuListener extends MouseAdapter{
	...
	private void maybeShowPopup(MouseEvent mouseEvent) {
		...
		if (mouseEvent.isPopupTrigger()) {
			...
			AcideExplorerPanel explorerPanel = AcideMainWindow.getInstance().getExplorerPanel();
			...
			if (AcideProjectConfiguration.getInstance()
				...
				explorerPanel.getPopupMenu().getSaveProjectMenuItem().setEnabled(false);
				
				// Disables the new file menu item
				explorerPanel.getPopupMenu().getNewProjectFileMenuItem().setEnabled(false);
				
				// Disables the add file menu item
				explorerPanel.getPopupMenu().getAddFileMenuItem().setEnabled(false);
				
				// Disables the remove file menu item
				explorerPanel.getPopupMenu().getRemoveFileMenuItem().setEnabled(false);
				
				// Disables the delete file menu item
				explorerPanel.getPopupMenu().getDeleteFileMenuItem().setEnabled(false);
				
				// Disables the set main file menu item
				explorerPanel.getPopupMenu().getSetMainFileMenuItem().setEnabled(false);
				
				// Disables the unset main file menu item
				explorerPanel.getPopupMenu().getUnsetMainFileMenuItem().setEnabled(false);
				
				// Disables the set compilable file menu item
				explorerPanel.getPopupMenu().getSetCompilableFileMenuItem().setEnabled(false);
				
				// Disables the unset compilable file menu item
				explorerPanel.getPopupMenu().getUnsetCompilableFileMenuItem().setEnabled(false);
				
				// Disables the add folder menu item
				explorerPanel.getPopupMenu().getAddFolderMenuItem().setEnabled(false);
				
				// Disables the remove folder menu item
				explorerPanel.getPopupMenu().getRemoveFolderMenuItem().setEnabled(false);
			} else {
				...
				explorerPanel.getPopupMenu().getNewProjectFileMenuItem().setEnabled(true);
				
				// Enables the add file menu item
				explorerPanel.getPopupMenu().getAddFileMenuItem().setEnabled(true);
				...
				explorerPanel.getPopupMenu().getAddFolderMenuItem().setEnabled(true);
				...
				if (AcideProjectConfiguration.getInstance()
					...
					explorerPanel.getPopupMenu().getSaveProjectMenuItem().setEnabled(true);
				...
				if (path != null) {
					...
					if (!file.isDirectory()) {
						...
						explorerPanel.getPopupMenu().getRemoveFileMenuItem().setEnabled(true);
						
						// Enables the delete file menu item
						explorerPanel.getPopupMenu().getDeleteFileMenuItem().setEnabled(true);
						
						// If it is not a MAIN FILE
						if (!file.isMainFile())
							
							// Enables the set main file menu item
							explorerPanel.getPopupMenu().getSetMainFileMenuItem().setEnabled(true);
						else
							// Enables the unset main file menu item
							explorerPanel.getPopupMenu().getUnsetMainFileMenuItem().setEnabled(true);
						...
						if (!file.isCompilableFile()
							...
							explorerPanel.getPopupMenu().getSetCompilableFileMenuItem().setEnabled(true);
						...
						if (file.isCompilableFile() && !file.isMainFile())
							...
							explorerPanel.getPopupMenu().getUnsetCompilableFileMenuItem().setEnabled(true);
					} else {
						
						// Enables the remove folder menu item
						explorerPanel.getPopupMenu().getRemoveFolderMenuItem().setEnabled(true);
					}
				}
			}
