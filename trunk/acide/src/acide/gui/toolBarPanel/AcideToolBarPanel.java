...
public class AcideToolBarPanel extends JPanel {
	...
	public void load(String filePath) {
		...
		try {
			...
			// Loads the console panel tool bar configuration lists
			AcideToolBarConfiguration.getInstance().load(filePath);
			...
			AcideResourceManager.getInstance().setProperty(
					"currentToolBarConfiguration", filePath);
			...
			JOptionPane.showMessageDialog(null, AcideLanguageManager
					...
					+ filePath, AcideLanguageManager.getInstance()
					.getLabels().getString("s907"), JOptionPane.ERROR_MESSAGE);
