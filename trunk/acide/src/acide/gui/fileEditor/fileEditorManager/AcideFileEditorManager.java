...
public class AcideFileEditorManager {
	...
	public void updatesTabbedPane(String filePath, String fileContent,
			boolean isEditable, AcideProjectFileType fileType,
			int caretPosition, int splitPaneDividerLocation, int activeTextEditionArea) {
		...
		try {
			...
			// Sets the active text edition area in the position stored in the file editor
			// configuration
			getSelectedFileEditorPanel().setActiveTextEditionArea(activeTextEditionArea);
	...
	public void setGreenButtonAt(int position) {
		AcideMainWindow.getInstance().getFileEditorManager().getTabbedPaneUI()
	...
	public void updatesButtonIcons() {
		...
		if (AcideMainWindow.getInstance().getFileEditorManager()
			...
			ImageIcon icon = (ImageIcon) AcideMainWindow.getInstance()
