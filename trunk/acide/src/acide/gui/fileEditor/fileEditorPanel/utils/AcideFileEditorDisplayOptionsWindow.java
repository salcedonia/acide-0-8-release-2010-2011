 ...
 */
package acide.gui.fileEditor.fileEditorPanel.utils;
...
public class AcideFileEditorDisplayOptionsWindow extends JFrame {
	 ...
	 */
	private int INITIAL_SIZE = AcideMainWindow.getInstance().getFileEditorManager()
			.getSelectedFileEditorPanel().getActiveTextEditionArea().getFont()
			.getSize();
	/**
	 * Current font style of the output in the main window.
	 */
	private int INITIAL_STYLE = AcideMainWindow.getInstance().getFileEditorManager()
			.getSelectedFileEditorPanel().getActiveTextEditionArea().getFont()
			.getStyle();
	/**
	 ...
	 */
	private Color INITIAL_FOREGROUND_COLOR = AcideMainWindow.getInstance()
			.getFileEditorManager().getSelectedFileEditorPanel()
			.getActiveTextEditionArea().getForeground();
	/**
	 * Current background color of the output in the main window.
	 */
	private Color INITIAL_BACKGROUND_COLOR = AcideMainWindow.getInstance()
			.getFileEditorManager().getSelectedFileEditorPanel()
