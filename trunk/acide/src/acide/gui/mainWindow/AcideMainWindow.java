...
public class AcideMainWindow extends JFrame {
	...
	public void buildToolBarPanel() {
		...
		try {
			...
			// Clears the console command list
			...
			// Loads the console command list from the current tool bar configuration
			AcideConsoleCommandList.loadFinalList(currentToolBarConfiguration);

			// Updates the ACIDE - A Configurable IDE current tool bar configuration
			...
			try {
				...
				try {
					...
					// Updates the the ACIDE - A Configurable IDE current tool bar configuration
					AcideResourceManager.getInstance().setProperty(
							"currentToolBarConfiguration",
				...
				if (AcideMainWindow.getInstance().getFileEditorManager()
					...
					if (AcideFileEditorConfiguration.getInstance()
						...
						if (AcideFileEditorConfiguration.getInstance()
							...
							// Sets the selected file editor from the file editor configuration
							AcideMainWindow
									.getInstance()
							...
							// Sets the selected file editor as the last tab in the file editor
							AcideMainWindow
									.getInstance()
									.getFileEditorManager()
									.setSelectedFileEditorPanelAt(
