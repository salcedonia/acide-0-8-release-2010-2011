...
public class AcideWorkbenchConfiguration {
	...
	public void load() {
		...
		try {
			...
			workbenchConfiguration = AcideResourceManager.getInstance()
	...
	public void load(String configurationFilePath) {
		...
		if ((configurationFilePath != null)
			...
			try {
				...
				AcideWorkbenchConfiguration workbenchConfiguration = (AcideWorkbenchConfiguration) xStream
				...
				AcideRecentFilesConfiguration recentFilesConfiguration = workbenchConfiguration
						.getRecentFilesConfiguration();

				// Gets the recent projects configuration
				AcideRecentProjectsConfiguration recentProjectsConfiguration = workbenchConfiguration
