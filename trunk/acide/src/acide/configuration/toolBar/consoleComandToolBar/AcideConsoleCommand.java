 ...
 * @version 0.8
 */
public class AcideConsoleCommand {
	 ...
	 *            ACIDE - A Configurable IDE console command parameter type.
	 */
	public AcideConsoleCommand(String name, String hintText,
	 ...
	 *            flag.
	 */
	public AcideConsoleCommand(String name, String action, String hintText,
			AcideParameterType parameterType) {
		_name = name;
		_action = action;
		_hintText = hintText;
