...
public class AcideProjectConfiguration {
	...
	public void load(String filePath) {
		...
		try {
			...
			// Gets the console panel buffer size
			initialPosition = finalPosition + 1;
			finalPosition = fileContent.indexOf("\n", initialPosition);
			...
			// Gets the ACIDE - A Configurable IDE main window vertical split
			// pane
			// divider location
			initialPosition = finalPosition + 1;
			finalPosition = fileContent.indexOf("\n", initialPosition);
			...
			// Gets the ACIDE - A Configurable IDE main window horizontal split
			// pane
			// divider location
			initialPosition = finalPosition + 1;
			finalPosition = fileContent.indexOf("\n", initialPosition);
			...
			if (!AcideWorkbenchConfiguration.getInstance().isWorkbenchLoaded()) {
				...
				_verticalSplitPaneDividerLocation = 150;
