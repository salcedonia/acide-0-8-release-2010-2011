...
public class AcideProjectConfiguration {
	...
	public String save() {
		...
		fileContent = fileContent + _consolePanelForegroundColor.toString()
				+ "\n";

		// Adds the console panel background color
		fileContent = fileContent + _consolePanelBackgroundColor.toString()
				+ "\n";
	...
	public void load(String filePath) {
		...
		initialPosition = finalPosition + 1;
		finalPosition = fileContent.indexOf("\n", initialPosition);
		_consolePanelForegroundColor = AcideUtilities.getInstance()
				.parseStringToColor(
						fileContent.substring(initialPosition, finalPosition));

		// Gets the console panel background color
		initialPosition = finalPosition + 1;
		finalPosition = fileContent.indexOf("\n", initialPosition);
		_consolePanelBackgroundColor = AcideUtilities.getInstance()
				.parseStringToColor(
						fileContent.substring(initialPosition, finalPosition));
