...
public class AcideLexiconConfiguration {
	...
	public void newLexicon(String path) {
		...
		// Updates the ACIDE - A Configurable IDE lexicon configuration
		AcideResourceManager.getInstance().setProperty("lexiconConfiguration", path);
	...
	public boolean save(String name, boolean isCompiledOrInterpreted) {
		...
		if ((_languageName != null)
			...
			// Updates the ACIDE - A Configurable IDE lexicon configuration
			AcideResourceManager.getInstance().setProperty("lexiconConfiguration",
					_languagePath);
		}
		return true;
	}
