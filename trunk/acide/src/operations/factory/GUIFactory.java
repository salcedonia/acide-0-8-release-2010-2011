...
import gui.output.OutputVisualizationGUI;
...
public class GUIFactory {
	 ...
	 */
	public OutputGUI buildOutputGUI() {
	...
	/**
	 * Build the output editor gui.
	 * 
	 * @return The output editor gui.
	 */
	public OutputVisualizationGUI buildOutputEditorGUI() {
		return new OutputVisualizationGUI();		
	}
}
