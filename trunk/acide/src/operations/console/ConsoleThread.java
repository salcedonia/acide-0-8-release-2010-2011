...
/**
 * Thread executed by the ACIDE - A Configurable IDE console panel.
 * 
 * @version 0.8
 * @see Thread
 */
public class ConsoleThread extends Thread {
	...
	/**
	 * Main method of the console thread.
	 */
	...
	private void setDefaultConfiguration() {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				MainWindow.getInstance().getConsolePanel().validate();

				// Repaint the console panel
				MainWindow.getInstance().getConsolePanel().repaint();
	...
	public void executeCommand(String shell, String shellPath, String command,
			String exit, AcideConsolePanel consolePanel) {
