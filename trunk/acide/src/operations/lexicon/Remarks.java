...
public class Remarks implements Serializable {
	 ...
	 */
	private static Remarks _instance;
	/**
	 * ACIDE - A Configurable IDE lexicon configuration remark symbol.
	 */
	private String _symbol;
	/**
	 * ACIDE - A Configurable IDE lexicon configuration remark is case sensitive flag.
	 */
	...
	/**
	 * ACIDE - A Configurable IDE lexicon configuration remark font style.
	 */
	 ...
	 *         remark class instance.
	 */
	public static Remarks getInstance() {
		if (_instance == null)
			_instance = new Remarks();
		return _instance;
	}
	 ...
	 *            new value to set.
	 */
	public void load(Remarks remark) {
		_instance = remark;
	}
	...
	/**
	 * Returns the ACIDE - A Configurable IDE lexicon configuration
	 * remark font style.
	 * 
	 * @return the ACIDE - A Configurable IDE lexicon configuration
	 * remark font style.
	 */
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE lexicon configuration
	 * remark is case sensitive flag.
	 * 
	 * @param isCaseSensitive new value to set.
	 */
