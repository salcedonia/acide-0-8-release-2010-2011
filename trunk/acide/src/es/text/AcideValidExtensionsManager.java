...
/**
 * ACIDE - A Configurable IDE valid extensions manager.
 * 
 * @version 0.8
 * @see Serializable
 */
public class AcideValidExtensionsManager implements Serializable {
	...
	/**
	 * ACIDE - A Configurable IDE valid extensions manager class serial version
	 * UID.
	 */
	private static final long serialVersionUID = 1L;
	/**
	 * ACIDE - A Configurable IDE valid extensions manager extension list.
	 */
	private ObjectList _list;
	/**
	 * ACIDE - A Configurable IDE valid extensions manager unique class
	 * instance.
	 */
	private static AcideValidExtensionsManager _instance;

	/**
	 * Creates a new ACIDE - A Configurable IDE valid extensions manager.
	 */
	 ...
	 *            new value to set.
	 */
	public void load(AcideValidExtensionsManager extensions) {
	...
	/**
	 * Returns the ACIDE - A Configurable IDE valid extensions manager. class
	 * instance.
	 * 
	 * @return the ACIDE - A Configurable IDE valid extensions manager. class
	 *         instance.
	 */
