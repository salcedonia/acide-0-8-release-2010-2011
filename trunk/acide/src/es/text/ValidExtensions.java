...
public class ValidExtensions implements Serializable {
	...
	/**
	 * Valid extension class instance.
	 */
	private static ValidExtensions _instance;

	/**
	 * Creates the valid extensions for the application.
	 */
	...
	/**
	 * Returns the unique valid extensions class instance.
	 * 
	 * @return the unique valid extensions class instance.
	 */
