 ...
 */
package es.configuration.window;
...
public class AcideWindowConfiguration {
	...
	public void load(String configurationFilePath) {
		...
		try {
			...
			Boolean isExplorerPanelShowed = windowConfiguration._isExplorerPanelShowed;
			
			// IS CONSOLE PANEL SHOWED
			Boolean isConsolePanelShowed = windowConfiguration._isConsolePanelShowed;

			// WIDTH
			Integer windowWidth = windowConfiguration._width;

			// HEIGHT
			Integer windowHeight = windowConfiguration._height;

			// WINDOW X COORDINATE
			Integer xCoordinate = windowConfiguration._xCoordinate;

			// WINDOW Y COORDINATE
			Integer yCoordinate = windowConfiguration._yCoordinate;

			// VERTICAL SPLIT PANE DIVIDER LOCATION
			Integer verticalSplitPaneDividerLocation = windowConfiguration._verticalSplitPaneDividerLocation;
			
			// HORIZONTAL SPLIT PANE DIVIDER LOCATION
			Integer horizontalSplitPaneDividerLocation = windowConfiguration._horizontalSplitPaneDividerLocation;
	...
	public boolean save() {
		...
		// IS EXPLORER PANEL SHOWED
		_isExplorerPanelShowed = MainWindow.getInstance().getMenu().getView().getShowExplorerPanel()
				.isSelected();

		// IS CONSOLE PANEL SHOWED
		_isConsolePanelShowed = MainWindow.getInstance().getMenu().getView().getShowConsolePanel()
				.isSelected();
		
		// WINDOW WIDTH
		_width = MainWindow.getInstance().getWidth();

		// WINDOW HEIGHT
		_height = MainWindow.getInstance().getHeight();

		// WINDOW X COORDINATE
		_xCoordinate = MainWindow.getInstance().getX();

		// WINDOW Y COORDINATE
		_yCoordinate = MainWindow.getInstance().getY();

		// VERTICAL SPLIT PANE DIVIDER LOCATION
		_verticalSplitPaneDividerLocation = MainWindow.getInstance().getVerticalSplitPane()
						.getDividerLocation();

		// HORIZONTAL SPLIT PANE DIVIDER LOCATION
		_horizontalSplitPaneDividerLocation = MainWindow.getInstance().getHorizontalSplitPane()
						.getDividerLocation();
