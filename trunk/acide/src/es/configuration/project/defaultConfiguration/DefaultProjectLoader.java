...
public class DefaultProjectLoader {
	...
	public String getDefaultFileContent() {
		...
		try {
			...
			if (fileContent == null) {
				...
				fileContent = textFile.load("./configuration/project/default.acidePrj");
	...
	public void load(String fileContent) {
		...
		PropertiesManager.setProperty("outputConfiguration", MainWindow.getInstance()
				.getProjectConfiguration().getOutputConfiguration());

		OutputConfiguration outputConfiguration = OutputConfiguration.getInstance();
		try {
