...
public class ProjectConfiguration {
	...
	public String save() {
		...
		if (MainWindow.getInstance().getMenu().getView().getShowBrowser().isSelected())
		...
		if (MainWindow.getInstance().getMenu().getView().getShowShellWindow().isSelected())
			_isShellShowed = true;
		else
		...
		fileContent = fileContent
				+ MainWindow.getInstance().getSplitPaneVertical().getDividerLocation() + "\n";
		fileContent = fileContent
				+ MainWindow.getInstance().getSplitPaneHorizontal().getDividerLocation()
				+ "\n";
	...
	public void saveMainWindowParameters() {
		...
		if (!isDefaultProject()) {
			...
			lines[15] = Integer.toString(MainWindow.getInstance().getSplitPaneVertical()
					.getDividerLocation());
			lines[16] = Integer.toString(MainWindow.getInstance().getSplitPaneHorizontal()
					.getDividerLocation());
	...
	/**
	 * Return true if the current project is "./configuration/project/default.acidePrj" and the 
	 * name is "".
	 * 
	...
	public boolean isDefaultProject(){
		...
		return project.equals("./configuration/project/default.acidePrj") || MainWindow
	...
	public void load(String fileContent) {
		...
		initialPosition = finalPosition + 1;
		finalPosition = fileContent.indexOf("\n", initialPosition);
		_outputConfiguration = fileContent.substring(initialPosition, finalPosition);
		...
		initialPosition = finalPosition + 1;
		finalPosition = fileContent.indexOf("\n", initialPosition);
		_menuConfiguration = fileContent.substring(initialPosition, finalPosition);

		// TOOLBAR CONFIGURATION PATH
		initialPosition = finalPosition + 1;
		finalPosition = fileContent.indexOf("\n", initialPosition);
		_toolBarConfiguration = fileContent.substring(initialPosition, finalPosition);
	...
	/**
	 * Set a new value to the output configuration.
	 * 
