	...
	public void loadTemp(String path) {
		...
		if ((path != null) && (!path.trim().equalsIgnoreCase(""))) {
			...
			try {
				...
				AcideLexiconConfiguration programmingLanguage = (AcideLexiconConfiguration) x
						.fromXML(f);
				...
				Remark comments = programmingLanguage._remarks;
				f.close();
				...
				Remark.getInstance().load(_remarks);
	...
	public void load(String path) {
		...
		if ((path != null) && (!path.trim().equalsIgnoreCase(""))) {
			try {
				...
				// VALID EXTENSIONS
				ValidExtensions validExtensions = lexiconConfiguration._validExtensions;
				
				// DELIMITER LIST
				DelimiterList delimiterList = lexiconConfiguration._delimiterList;
				
				// REMARKS
				Remark remarks = lexiconConfiguration._remarks;
				f.close();
