...
public class ConsoleCommandList {
	 ...
	 */
	private static ArrayList<ConsoleCommand> _finalList;
	/**
	 * Shell command list to store temporally the loaded values from the
	 * configuration file.
	 */
	private static ArrayList<ConsoleCommand> _temporalList;
	...
	public ConsoleCommandList() {
		...
		_finalList = new ArrayList<ConsoleCommand>();
		_temporalList = new ArrayList<ConsoleCommand>();
	}
	...
	public static boolean save(String path,
			ArrayList<ConsoleCommand> temporalList) {

		String textContent = "";

		for (ConsoleCommand shellCommand : temporalList) {
	...
	public static void load(String path,
			ArrayList<ConsoleCommand> temporalList) throws Exception {
		...
		ConsoleCommand shellCommand = new ConsoleCommand();
			...
			if (!line.isEmpty()) {
				...
				if (!line.startsWith("//")) {
					...
					if (count > 1) {
						...
						shellCommand = new ConsoleCommand();
					}
				}
			}
		}
	 ...
	 * @return true if the result was succeed and false in other case.
	 */
	public static boolean addCommand(ConsoleCommand command) {
	 ...
	 * @return true if the result was succeed and false in other case.
	 */
	public static boolean removeCommand(ConsoleCommand command) {
	 ...
	 *         parameter.
	 */
	public static ConsoleCommand getShellCommandAt(int position) {
		return (ConsoleCommand) _finalList.get(position);
	}
	 ...
	 */
	public static ArrayList<ConsoleCommand> getFinalList() {
		return _finalList;
	}
	 ...
	 *            new value to set.
	 */
	public static void setFinalList(ArrayList<ConsoleCommand> list) {

		_finalList.clear();

		for (ConsoleCommand shellCommand : list)
	 ...
	 *            new value to set.
	 */
	public static void setTemporalList(ArrayList<ConsoleCommand> list) {
	 ...
	 */
	public static ArrayList<ConsoleCommand> getTemporalList() {
