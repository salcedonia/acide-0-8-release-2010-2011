...
public class AcideProjectFile {
	...
	/**
	 * ACIDE - A Configurable IDE project file flag that indicates if the file is a directory or not.
	 */
	private boolean _isDirectory;
	/**
	 * ACIDE - A Configurable IDE project file flag that indicates if the file is opened or not.
	 */
	private boolean _isOpened;
	/**
	 * ACIDE - A Configurable IDE project file flag that indicates if the file is a compilable file or not.
	 */
	private boolean _isCompilableFile;
	/**
	 * ACIDE - A Configurable IDE project file flag that indicates if the file is a main file or not.
	 */
	...
	/**
	 * Sets a new value to the string of the ACIDE - A Configurable project file class.
	 * 
	 * @param string
	 *            new value to set.
	 */
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE project file is main file flag.
	 * 
	 * @param isMainFile
	 *            new value to set.
	 */
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE project file absolute path.
	 * 
	 * @param path
	 *            new value to set.
	 */
	...
	/**
	 * Returns the ACIDE - A Configurable IDE project file is compilable file flag.
	 * 
	 * @return the ACIDE - A Configurable IDE project file is compilable file flag.
	 */
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE project file is compilable file flag.
	 * 
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE project file is directory flag.
	 * 
	 * @param isDirectory
	 *            new value to set.
	 */
	...
	/**
	 * Returns the ACIDE - A Configurable IDE project file name extracted from the
	 * absolute path.
	 * 
	 * @return the ACIDE - A Configurable IDE project file name extracted from the
	 * absolute path.
	 */
	public String getFileName() {
		...
		if (index == -1)
			index = _absolutePath.lastIndexOf("/");
		return _absolutePath.substring(index + 1, _absolutePath.lastIndexOf("."));
	}
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE project file is opened file flag.
	 * 
	 * @param isOpened
	 *            new value to set.
	 */
