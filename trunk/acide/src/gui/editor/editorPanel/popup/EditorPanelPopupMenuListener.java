 ...
 * @see MouseAdapter
 ***********************************************************************/
public class EditorPanelPopupMenuListener extends MouseAdapter {
	...
	private void maybeShowPopup(MouseEvent mouseEvent) {
		...
		if (mouseEvent.isPopupTrigger()) {
			...
			EditorPanel selectedEditor = MainWindow.getInstance().getEditorManager()
					.getSelectedEditor();
			...
			if (selectedEditor.getEditor().getSelectedText() != null) {
