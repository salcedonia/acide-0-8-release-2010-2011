...
public class SaveAllFilesListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		int selectedEditorIndex = MainWindow.getInstance().getEditorManager().getSelectedEditorIndex();		
		...
		MainWindow.getInstance().getEditorManager().setSelectedEditorAt(selectedEditorIndex);
	}
}
