	...
	class ExitListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (option == JOptionPane.OK_OPTION) {
				...
				// UPDATES THE LOG
				_logger.info(labels.getString("s77"));
				...
				// CHECK THE OPEN FILES IN THE EDITOR
				int editorBuilder = mainWindow.getEditorBuilder()
						.getSelectedEditorIndex();
				int numEditors = mainWindow.getEditorBuilder().getNumEditors();

				// START WITH THE LAST ONE
				mainWindow.getEditorBuilder().setSelectedEditorAt(
						numEditors - 1);
				...
				mainWindow.getEditorBuilder()
						.setSelectedEditorAt(editorBuilder);
				...
				OperationsFactory.getInstance().buildDefaultConfiguration()
						.save();
				...
				_logger.info(labels.getString("s78"));
			}
		}
	}
