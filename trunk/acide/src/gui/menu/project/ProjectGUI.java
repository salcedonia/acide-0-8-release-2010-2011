	...
	public ProjectGUI() {
		...
		_languageConfigurationPanel.setBorder(BorderFactory
				.createTitledBorder(BorderFactory.createTitledBorder(null,
						_labels.getString("s590"), TitledBorder.LEADING,
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!_nameTextField.getText().equals("")
					...
					if (selected) {
						...
						// SHELL FONT STYLE
						OutputConfiguration.getInstance().setFontStyle(fontStyleString);
				...
				// WARNING MESSAGES
				if (_nameTextField.getText().equals(""))
					JOptionPane.showMessageDialog(null, _labels
							.getString("s973"), _labels.getString("s972"),
							JOptionPane.WARNING_MESSAGE);

				if (_lexicalConfigurationNameLabel.getText().contains(
						_labels.getString("s598")))
					JOptionPane.showMessageDialog(null, _labels
							.getString("s974"), _labels.getString("s972"),
							JOptionPane.WARNING_MESSAGE);

				if (_grammarConfigurationNameLabel.getText().contains(
						_labels.getString("s598")))
					JOptionPane.showMessageDialog(null, _labels
							.getString("s975"), _labels.getString("s972"),
							JOptionPane.WARNING_MESSAGE);
			}
		});
