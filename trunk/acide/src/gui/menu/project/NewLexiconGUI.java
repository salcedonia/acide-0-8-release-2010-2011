...
public class NewLexiconGUI extends JFrame {
	...
	public NewLexiconGUI() {
		...
		_namePanel.setBorder(BorderFactory.createTitledBorder(labels
				.getString("s353")));
		...
		_extensionsPanel.setBorder(BorderFactory.createTitledBorder(labels
				.getString("s355")));
		
		// TYPE PANEL
		_typePanel = new JPanel();
		_typePanel.setLayout(new GridLayout(1, 0));
		_typePanel.setBorder(BorderFactory.createTitledBorder(labels
				.getString("s356")));
		...
		_btnLexicalConfiguration.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ProgrammingLanguage.getInstance().setName(
						_tfName.getText());
				new LexiconGUI();
			}
		});
		...
		_btnAccept.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (mainWindow.getProjectGUI() != null) {
					mainWindow.getProjectGUI().setNombreConfLexico(programmingLanguage.getName());
					mainWindow.getProjectGUI().setNombreConfLabelLexico(
							labels.getString("s599")
									+ mainWindow.getProjectGUI().getNombreConfLexico());
					MainWindow
							.getInstance()
							.getStatusBar()
							.setMessagelexical(
		...
		_btnCancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					ProgrammingLanguage.getInstance().load(_undoPath);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
				_frame.dispose();
