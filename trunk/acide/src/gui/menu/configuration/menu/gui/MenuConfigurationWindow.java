package gui.menu.configuration.menu.gui;
 ...
 * 
 */
public class MenuConfigurationWindow {
	...
	public MenuConfigurationWindow(boolean isModify) {
		...
		_filePanel.setBorder(BorderFactory.createTitledBorder(null, labels
		...
		_editPanel.setBorder(BorderFactory.createTitledBorder(null, labels
		...
		_projectPanel.setBorder(BorderFactory.createTitledBorder(null, labels
		...
		_viewPanel.setBorder(BorderFactory.createTitledBorder(null, labels
		...
		_languagePanel.setBorder(BorderFactory.createTitledBorder(null, labels
				.getString("s505"),TitledBorder.LEADING,
				TitledBorder.DEFAULT_POSITION, new Font("Tahoma", 1, 12),
				new Color(0, 0, 0)));
		// LEXICAL SUBMENU
		...
		_helpPanel.setBorder(BorderFactory.createTitledBorder(null, labels
		...
		_bntAccept.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (_changesAreSaved)
						PropertiesManager.setProperty("previousMenuConfiguration",
								previousMenu);
