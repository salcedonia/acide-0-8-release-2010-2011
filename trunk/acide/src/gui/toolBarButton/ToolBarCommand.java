...
import es.configuration.toolBar.EditableToolBarCommand;
...
/**
 * Handle the toolBar command of the application.
 * 
...
public class ToolBarCommand extends JPanel {
	...
	/**
	 * Builds the toolBar of the application.
	 * 
