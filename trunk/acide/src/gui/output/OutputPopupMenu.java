...
public class OutputPopupMenu extends JPopupMenu {
	...
	/**
	 * Output editor settings menu item.
	 */
	private JMenuItem _editorSettings;
	/**
	 * Reset menu item.
	 */
	...
	public OutputPopupMenu() {
		...
		// OUTPUT EDITOR
		_editorSettings = new JMenuItem(labels.getString("s986"));
		_editorSettings.addActionListener(new ActionListener() {
			/*
			 * (non-Javadoc)
			 * 
			 * @see
			...
			public void actionPerformed(ActionEvent arg0) {				
				GUIFactory.getInstance().buildOutputEditorGUI();
			}
		});
		add(_editorSettings);
		addSeparator();
