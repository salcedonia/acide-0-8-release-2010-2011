...
public class AcideMenuConfigurationWindow extends JFrame {
	...
	/**
	 * ACIDE - A Configurable IDE menu configuration window open recent files check box.
	 */
	...
	public void addProjectMenuInformation(
		...
		menuItemList
				.add(new AcideMenuItemInformation(ProjectMenu.NEW_PROJECT_NAME,
						_newProjectCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ProjectMenu.OPEN_PROJECT_NAME, _openProjectCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ProjectMenu.SAVE_PROJECT_NAME, _saveProjectCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ProjectMenu.ADD_FILE_NAME, _addFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ProjectMenu.CLOSE_PROJECT_NAME, _closeProjectCheckBox
						.isSelected()));
		menuItemList
				.add(new AcideMenuItemInformation(ProjectMenu.REMOVE_FILE_NAME,
						_removeFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ProjectMenu.ADD_FOLDER_NAME, _addFolderCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
		...
		menuItemList.add(new AcideMenuItemInformation(
				ProjectMenu.NEW_PROJECT_FILE_NAME, _newProjectFileCheckBox
						.isSelected()));
		menuItemList
				.add(new AcideMenuItemInformation(ProjectMenu.DELETE_FILE_NAME,
	...
	public void addLexiconMenuInformation(
		...
		menuItemList.add(new AcideMenuItemInformation(
				LexiconMenu.LOAD_LEXICON_NAME, _loadLexiconCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				LexiconMenu.MODIFY_LEXICON_NAME, _modifyLexiconCheckBox
						.isSelected()));
		menuItemList
				.add(new AcideMenuItemInformation(LexiconMenu.NEW_LEXICON_NAME,
						_newLexiconCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				LexiconMenu.SAVE_LEXICON_NAME, _saveLexiconCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
	...
	public void AddGrammarMenuInformation(
		...
		menuItemList
				.add(new AcideMenuItemInformation(
						GrammarMenu.NEW_GRAMMAR_NAME, _newGrammarCheckBox
								.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				GrammarMenu.LOAD_GRAMMAR_NAME, _loadGrammarCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				GrammarMenu.MODIFY_GRAMMAR_NAME, _modifyGrammarCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				GrammarMenu.SAVE_GRAMMAR_NAME, _saveGrammarCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				GrammarMenu.SAVE_GRAMMAR_AS_NAME, _saveGrammarAsCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				GrammarMenu.SET_PATHS_NAME, _setPathsCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
	...
	public void addLanguageMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList.add(new AcideMenuItemInformation(
				LanguageMenu.ENGLISH_NAME, _englishCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				LanguageMenu.SPANISH_NAME, _spanishCheckBox.isSelected()));
	}
	...
	public void addOutputMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList.add(new AcideMenuItemInformation(
				ConsoleMenu.CONFIGURE_NAME, _configureCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
	...
	public void addToolBarMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList
				.add(new AcideMenuItemInformation(ToolBarMenu.NEW_TOOLBAR_NAME,
						_newToolBarCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ToolBarMenu.LOAD_TOOLBAR_NAME, _loadToolBarCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ToolBarMenu.MODIFY_TOOLBAR_NAME, _modifyToolBarCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ToolBarMenu.SAVE_TOOLBAR_NAME, _saveToolBarCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
	...
	public void addViewMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList.add(new AcideMenuItemInformation(
				ViewMenu.SHOW_LOG_TAB_NAME, _showLogTabCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
	...
	public void addHelpMenuInformation(
		...
		menuItemList
				.add(new AcideMenuItemInformation(HelpMenu.SHOW_ABOUT_US_NAME,
	...
	public void addFileMenuInformation(
		...
		menuItemList.add(new AcideMenuItemInformation(FileMenu.OPEN_RECENT_FILES_NAME,
				_openRecentFilesCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.OPEN_ALL_FILES_NAME,
				_openFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				FileMenu.SAVE_FILE_AS_NAME, _saveFileAsCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.SAVE_FILE_NAME,
				_saveFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				FileMenu.SAVE_ALL_FILES_NAME, _saveAllFilesCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.CLOSE_FILE_NAME,
				_closeFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				FileMenu.CLOSE_ALL_FILES_NAME, _closeAllFilesCheckBox
						.isSelected()));
	...
	class AcceptButtonAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			try {
				...
				// Gets the previous menu configuration
				...
				// Disables the save menu item in the configuration menu
