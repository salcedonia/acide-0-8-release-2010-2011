...
public class AcideMenuConfigurationWindow extends JFrame {
	 ...
	 */
	public AcideMenuConfigurationWindow(boolean isModify) {
		...
		_acceptButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				AcideMenuConfiguration.getInstance().saveMenuConfigurationFile(newName, menuItemList);
				
				try {

					String previousMenu = AcideResourceManager.getInstance()
							.getProperty("currentMenuConfiguration");
		...
		_saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				if (chosenOption == JFileChooser.APPROVE_OPTION) {
					...
					AcideMenuConfiguration.getInstance().saveMenuConfigurationFile(fileName,
							menuItemList);
	...
	public void setCheckBoxesFromMenuItemList() {
		...
		// FILE MENU
		_newFileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.NEW_FILE_NAME));
		_openFileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.OPEN_FILE_NAME));
		_openAllFilesCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.OPEN_ALL_FILES_NAME));
		_saveFileAsCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.SAVE_FILE_AS_NAME));
		_saveFileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.SAVE_FILE_NAME));
		_saveAllFilesCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.SAVE_ALL_FILES_NAME));
		_closeFileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.CLOSE_FILE_NAME));
		_closeAllFilesCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.CLOSE_ALL_FILES_NAME));
		_printFileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.PRINT_FILE_NAME));
		_exitCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(FileMenu.EXIT_NAME));

		// EDIT FILE
		_undoCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(EditMenu.UNDO_NAME));
		_redoCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(EditMenu.REDO_NAME));
		_copyCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(EditMenu.COPY_NAME));
		_pasteCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(EditMenu.PASTE_NAME));
		_cutCheckBox.setSelected(AcideMenuConfiguration
		...
		_goToLineCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(EditMenu.GO_TO_LINE_NAME));
		_searchCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(EditMenu.SEARCH_NAME));
		_replaceCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(EditMenu.REPLACE_NAME));

		// PROJECT MENU
		_newProjectCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.NEW_PROJECT_NAME));
		_openProjectCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.OPEN_PROJECT_NAME));
		_saveProjectCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.SAVE_PROJECT_NAME));
		_addFileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.ADD_FILE_NAME));
		_removeFileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.REMOVE_FILE_NAME));
		_addFolderCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.ADD_FOLDER_NAME));
		_removeFolderCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.REMOVE_FOLDER_NAME));
		_compileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.COMPILE_NAME));
		_executeCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.EXECUTE_NAME));
		_saveProjectAsCheckBox.setSelected(AcideMenuConfiguration
		...
		_closeProjectCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.CLOSE_PROJECT_NAME));
		_deleteFileCheckBox.setSelected(AcideMenuConfiguration
		...
		_setMainFileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.SET_MAIN_FILE_NAME));
		_unsetMainFileCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ProjectMenu.UNSET_MAIN_FILE_NAME));
		
		// VIEW MENU
		_showLogTabCheckBox.setSelected(AcideMenuConfiguration
		...
		_showOutputPanelCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ViewMenu.SHOW_CONSOLE_PANEL_NAME));
		
		// LEXICON MENU
		_loadLexiconCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(LexiconMenu.LOAD_LEXICON_NAME));
		_modifyLexiconCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(LexiconMenu.MODIFY_LEXICON_NAME));
		_newLexiconCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(LexiconMenu.NEW_LEXICON_NAME));
		_saveLexiconCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(LexiconMenu.SAVE_LEXICON_NAME));
		_saveLexiconAsCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(LexiconMenu.SAVE_LEXICON_AS_NAME));
		
		// GRAMMAR MENU
		_newGrammarCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(GrammarMenu.NEW_GRAMMAR_NAME));
		_loadGrammarCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(GrammarMenu.LOAD_GRAMMAR_NAME));
		_modifyGrammarCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(GrammarMenu.MODIFY_GRAMMAR_NAME));
		_saveGrammarCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(GrammarMenu.SAVE_GRAMMAR_NAME));
		_saveGrammarAsCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(GrammarMenu.SAVE_GRAMMAR_AS_NAME));
		_setPathsCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(GrammarMenu.SET_PATHS_NAME));
		_autoAnalysisCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(GrammarMenu.AUTO_ANALYSIS_NAME));
		
		// OUTPUT MENU
		_configureCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ConsoleMenu.CONFIGURE_NAME));
		_externalCommandCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ConsoleMenu.EXTERNAL_COMMAND_NAME));
		_shellDisplayOptionsCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ConsoleMenu.CONSOLE_DISPLAY_OPTIONS_NAME));
		
		// LANGUAGE MENU
		_spanishCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(LanguageMenu.SPANISH_NAME));
		_englishCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(LanguageMenu.ENGLISH_NAME));
		
		// CONFIGURATION MENU
		_menuCheckBox.setSelected(true);
		_toolBarCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ConfigurationMenu.TOOLBAR_NAME));
		_compilerCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ConfigurationMenu.COMPILER_NAME));
		
		// HELP MENU
		_showHelpCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(HelpMenu.SHOW_HELP_NAME));
		_showAboutUsCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(HelpMenu.SHOW_ABOUT_US_NAME));
				
		// MENU MENU
		_newMenuCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(MenuMenu.NEW_MENU_NAME));
		_loadMenuCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(MenuMenu.LOAD_MENU_NAME));
		_modifyMenu.setSelected(true);
		_saveMenuCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(MenuMenu.SAVE_MENU_NAME));
		_saveMenuAsCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(MenuMenu.SAVE_MENU_AS_NAME));
		
		// TOOL BAR MENU
		_newToolBarCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ToolBarMenu.NEW_TOOLBAR_NAME));
		_loadToolBarCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ToolBarMenu.LOAD_TOOLBAR_NAME));
		_modifyToolBarCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ToolBarMenu.MODIFY_TOOLBAR_NAME));
		_saveToolBarCheckBox.setSelected(AcideMenuConfiguration
				.getInstance().getIsDisplayed(ToolBarMenu.SAVE_TOOLBAR_NAME));
		_saveToolBarAsCheckBox.setSelected(AcideMenuConfiguration
	...
	public void addProjectMenuInformation(
		...
		menuItemList.add(new AcideMenuItemInformation(ProjectMenu.NEW_PROJECT_NAME,
				_newProjectCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ProjectMenu.OPEN_PROJECT_NAME,
				_openProjectCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ProjectMenu.SAVE_PROJECT_NAME,
				_saveProjectCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ProjectMenu.ADD_FILE_NAME,
		...
		menuItemList.add(new AcideMenuItemInformation(
				ProjectMenu.CLOSE_PROJECT_NAME, _closeProjectCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ProjectMenu.REMOVE_FILE_NAME,
				_removeFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ProjectMenu.ADD_FOLDER_NAME,
				_addFolderCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ProjectMenu.REMOVE_FOLDER_NAME, _removeFolderCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ProjectMenu.COMPILE_NAME,
				_compileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ProjectMenu.EXECUTE_NAME,
		...
		menuItemList.add(new AcideMenuItemInformation(
				ProjectMenu.NEW_PROJECT_FILE_NAME, _newProjectFileCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ProjectMenu.DELETE_FILE_NAME,
	...
	public void addConfigurationMenuInformation(
		...
		menuItemList.add(new AcideMenuItemInformation(ConfigurationMenu.MENU_NAME,
				true));
		menuItemList.add(new AcideMenuItemInformation(
				ConfigurationMenu.TOOLBAR_NAME, _toolBarCheckBox.isSelected()));
		menuItemList
				.add(new AcideMenuItemInformation(ConfigurationMenu.COMPILER_NAME,
	...
	public void addLexiconMenuInformation(
		...
		menuItemList.add(new AcideMenuItemInformation(LexiconMenu.LOAD_LEXICON_NAME,
				_loadLexiconCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				LexiconMenu.MODIFY_LEXICON_NAME, _modifyLexiconCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(LexiconMenu.NEW_LEXICON_NAME,
				_newLexiconCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(LexiconMenu.SAVE_LEXICON_NAME,
	...
	public void AddGrammarMenuInformation(
		...
		menuItemList.add(new AcideMenuItemInformation(GrammarMenu.LOAD_GRAMMAR_NAME,
		...
		menuItemList.add(new AcideMenuItemInformation(
				GrammarMenu.MODIFY_GRAMMAR_NAME, _modifyGrammarCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(GrammarMenu.SAVE_GRAMMAR_NAME,
				_saveGrammarCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				GrammarMenu.SAVE_GRAMMAR_AS_NAME, _saveGrammarAsCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(GrammarMenu.SET_PATHS_NAME,
	...
	public void addMenuMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList.add(new AcideMenuItemInformation(MenuMenu.NEW_MENU_NAME,
				_newMenuCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(MenuMenu.LOAD_MENU_NAME,
				_loadMenuCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(MenuMenu.MODIFY_MENU_NAME,
				true));
		menuItemList.add(new AcideMenuItemInformation(MenuMenu.SAVE_MENU_NAME,
				_saveMenuCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(MenuMenu.SAVE_MENU_AS_NAME,
	...
	public void addLanguageMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList.add(new AcideMenuItemInformation(LanguageMenu.ENGLISH_NAME,
				_englishCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(LanguageMenu.SPANISH_NAME,
	...
	public void addOutputMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList.add(new AcideMenuItemInformation(ConsoleMenu.CONFIGURE_NAME,
				_configureCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ConsoleMenu.EXTERNAL_COMMAND_NAME, _externalCommandCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ConsoleMenu.CONSOLE_DISPLAY_OPTIONS_NAME, _shellDisplayOptionsCheckBox
						.isSelected()));
	}
	...
	public void addToolBarMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList.add(new AcideMenuItemInformation(ToolBarMenu.NEW_TOOLBAR_NAME,
				_newToolBarCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ToolBarMenu.LOAD_TOOLBAR_NAME,
				_loadToolBarCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ToolBarMenu.MODIFY_TOOLBAR_NAME, _modifyToolBarCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(ToolBarMenu.SAVE_TOOLBAR_NAME,
	...
	public void addViewMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList.add(new AcideMenuItemInformation(ViewMenu.SHOW_LOG_TAB_NAME,
				_showLogTabCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ViewMenu.SHOW_EXPLORER_PANEL_NAME, _showExplorerPanelCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				ViewMenu.SHOW_CONSOLE_PANEL_NAME, _showOutputPanelCheckBox
						.isSelected()));
	}
	...
	public void addHelpMenuInformation(
			ArrayList<AcideMenuItemInformation> menuItemList) {
		menuItemList.add(new AcideMenuItemInformation(HelpMenu.SHOW_HELP_NAME,
				_showHelpCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(HelpMenu.SHOW_ABOUT_US_NAME,
	...
	public void addEditMenuInformation(
		...
		menuItemList.add(new AcideMenuItemInformation(EditMenu.UNDO_NAME,
				_undoCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(EditMenu.REDO_NAME,
				_redoCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(EditMenu.COPY_NAME,
				_copyCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(EditMenu.PASTE_NAME,
				_pasteCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(EditMenu.CUT_NAME,
				_cutCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(
				EditMenu.SELECT_ALL_FILES_NAME, _selectAllFilesCheckBox
						.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(EditMenu.GO_TO_LINE_NAME,
				_goToLineCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(EditMenu.SEARCH_NAME,
				_searchCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(EditMenu.REPLACE_NAME,
	...
	public void addFileMenuInformation(
		...
		menuItemList.add(new AcideMenuItemInformation(FileMenu.NEW_FILE_NAME,
				_newFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.OPEN_FILE_NAME,
				_openFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.SAVE_FILE_AS_NAME,
				_saveFileAsCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.SAVE_FILE_NAME,
				_saveFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.SAVE_ALL_FILES_NAME,
				_saveAllFilesCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.CLOSE_FILE_NAME,
				_closeFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.CLOSE_ALL_FILES_NAME,
				_closeAllFilesCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.PRINT_FILE_NAME,
				_printFileCheckBox.isSelected()));
		menuItemList.add(new AcideMenuItemInformation(FileMenu.EXIT_NAME,
