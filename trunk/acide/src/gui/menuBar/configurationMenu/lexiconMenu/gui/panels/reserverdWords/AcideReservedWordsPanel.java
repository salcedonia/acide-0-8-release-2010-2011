 ...
 */
package gui.menuBar.configurationMenu.lexiconMenu.gui.panels.reserverdWords;
...
public class AcideReservedWordsPanel extends JPanel {
	...
	public JScrollPane buildTable() {
		...
		_table.setDefaultRenderer(Color.class, new ColorCellRenderer(true));
		_table.setDefaultEditor(Color.class, new CellColorEditor());
