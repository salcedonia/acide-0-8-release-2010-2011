...
public class AcideDelimitersPanel extends JPanel{
	...
	public AcideDelimitersPanel(){
		...
		_delimiterListTableColumns[0] = labels.getString("s440");
		...
		setBorder(BorderFactory.createTitledBorder(null,
				labels.getString("s429"), TitledBorder.LEADING,
				TitledBorder.DEFAULT_POSITION));
		
		// DELIMITER LABEL
		_delimiterLabel = new JLabel(labels.getString("s432"), JLabel.CENTER);
		
		// DELIMITER TEXT FIELD
		_delimiterTextField = new JTextField();
		
		// ADD DIVIDER BUTTON
		_addButton = new JButton(labels.getString("s385"));
		...
		_deleteButton = new JButton(labels.getString("s387"));
	...
	public JScrollPane buildDelimiterListTable() {
		...
		_delimiterListTable.setDefaultRenderer(Color.class, new ColorCellRenderer(
				true));
		_delimiterListTable.setDefaultEditor(Color.class, new CellColorEditor());
