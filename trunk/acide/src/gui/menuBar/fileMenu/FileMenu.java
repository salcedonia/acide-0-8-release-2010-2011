...
import gui.menuBar.fileMenu.recentFilesMenu.RecentFilesMenu;
...
public class FileMenu extends JMenu {
	...
	/**
	 * ACIDE - A Configurable IDE file menu open recent files menu item.
	 */
	private RecentFilesMenu _openRecentFiles;
	/**
	...
	public FileMenu() {
		...
		_openRecentFiles = new RecentFilesMenu();
	...
	public void setLanguageLabels() {
		...
		// OPEN RECENT FILES
		_openRecentFiles.setText(labels.getString("s1038"));
		...
		//_openRecentFiles.setEnabled(false);
	 ...
	 *         item.
	 */
	public RecentFilesMenu getOpenRecentFiles() {
		return _openRecentFiles;
	}

	/**
	 * Sets a new value to the ACIDE - A Configurable IDE file menu open recent
	 * files menu item.
	 * 
	 * @param openRecentFiles
	 *            new value to set.
	 */
	public void setOpenRecentFiles(RecentFilesMenu openRecentFiles) {
		_openRecentFiles = openRecentFiles;
	}
