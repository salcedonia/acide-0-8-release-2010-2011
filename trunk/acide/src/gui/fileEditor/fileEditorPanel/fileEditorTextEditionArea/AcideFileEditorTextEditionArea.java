...
import gui.fileEditor.fileEditorPanel.fileEditorTextEditionArea.listeners.AcideFileEditorAdjustmentListener;
import gui.fileEditor.fileEditorPanel.fileEditorTextEditionArea.listeners.AcideFileEditorCaretListener;
import gui.fileEditor.fileEditorPanel.fileEditorTextEditionArea.listeners.AcideFileEditorMouseListener;
import gui.fileEditor.fileEditorPanel.fileEditorTextEditionArea.listeners.AcideFileEditorScrollPaneMouseListener;
...
public class AcideFileEditorTextEditionArea {
	...
	protected void buildTextPane(AcideStyledDocument styledDocument) {
		...
		_textPane = new JTextPane(styledDocument) {
	 ...
	 *         panel.
	 */
	public LineNumberComponent getLineNumberPanel() {
