 ...
 */
package gui.toolBarPanel.consoleCommandToolBar;
...
public class AcideConsoleCommandToolBar extends ArrayList<Component> {
	...
	public AcideConsoleCommandToolBar build() {
		...
		JButton button;
		for (int command = 0; command < ConsoleCommandList.getSize(); command++) {

			final ConsoleCommand newCommand = ConsoleCommandList
