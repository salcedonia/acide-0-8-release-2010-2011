...
public class MainWindow extends JFrame {
	...
	public void closeDefaultProject() {
		...
		try {
			...
			// IF IT IS THE DEFAULT CONFIGURATION AND IT DOESN'T HAVE OTHER PROJECT
			if (file.equals("./configuration/default.acidePrj")) {
				...
				textFile.save("./configuration/default.acidePrj",
	...
	public class MainWindowListener extends WindowAdapter {
		...
		public void windowClosing(WindowEvent arg0) {
			...
			for (int cont = numEditors - 1; cont >= 0; cont--) {
				mainWindow.getEditorBuilder().setSelectedEditorAt(cont);
