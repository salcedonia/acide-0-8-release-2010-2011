...
/**
 * Handles the Printer of the application.
 * 
...
public class PrinterText implements Printable {
	...
	static class ParentView extends View {
		 ...
		 * 
		 * @param v View.
		 * @param viewFactory View factory of the window.
		 ...
		 * the View hierarchy.
		 * 
		 * @return Key pieces of information required by
		 * the View hierarchy.
		 */
		 ...
		 * @param a Shape.
		 * @param bias Position bias array.
		 * 
		 * @return 0.
		 */
	...
	/**
	 * Set a new value to showPage flag.
	 * 
	...
	/**
	 * Set a new value to showDate flag.
	 * 
